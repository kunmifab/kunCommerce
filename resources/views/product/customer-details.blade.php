    ...
    <h2 class="text-center">Fill Customer's Credentials</h2>
        <form action="{{route('product.customer-update', ['id'=>$product->id])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input name="phone_num" id="phone_num" type="text" class="form-control" @if (auth()->user()->phone_num != null)
            ...
            <div class="form-group">
                ...
                <textarea name="address_1" class="form-control" id="address_1" cols="20" rows="5">@if (auth()->user()->address_1 != null)
                    {{auth()->user()->address_1}}
                @endif</textarea>
            </div>
            @error('address_1')
            ...
            <div class="form-group">
                ...
                <textarea name="address_2" class="form-control" id="address_2" cols="20" rows="5">@if (auth()->user()->address_2 != null)
                    {{auth()->user()->address_2}}
                @endif</textarea>
            </div>
            @error('address_2')
